...
//InsertMany insert many personalLoan in instition
func (s *service) InsertMany(personalLoans []Entity, institututionID string) common.CustomError {

	for _, personalLoan := range personalLoans {
		personalLoan.InstitutionID = institututionID
		s.repository.Save(personalLoan)
	}
